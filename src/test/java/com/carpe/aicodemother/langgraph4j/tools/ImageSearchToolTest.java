package com.carpe.aicodemother.langgraph4j.tools;

import com.carpe.aicodemother.langgraph4j.enums.ImageCategoryEnum;
...
class ImageSearchToolTest {
    ...
    void testSearchContentImages() {
        // 测试正常搜索
        List<ImageResource> images = imageSearchTool.searchContentImages("Tifa");
