...
import com.carpe.aicodemother.langgraph4j.CodeGenConcurrentWorkflow;
...
class CodeGenConcurrentWorkflowTest {
    ...
    void testConcurrentWorkflow() {
        WorkflowContext result = new CodeGenConcurrentWorkflow().executeWorkflow("创建一个技术博客网站，需要展示编程教程和系统架构, 用简单 HTML 创建");
